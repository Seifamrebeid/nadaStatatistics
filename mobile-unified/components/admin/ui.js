// Admin UI kit (unified) — emerald brand. Matches the API used by mobile-doctor /
// mobile-student / mobile-parent so screens are copy-compatible across apps.
// The older standalone components (Screen, Card, Button, EmptyState, etc.) stay
// where they are — this file is additive.
...
export const styles = StyleSheet.create({
  ...
  statLabel: { color: colors.muted, fontSize: 11, fontWeight: "700", letterSpacing: 0.6, textTransform: "uppercase", marginBottom: 6 },
  statValue: { fontSize: 26, fontWeight: "700", letterSpacing: -0.5 },
  button: { minHeight: 46, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 12, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8 },
  primaryButton: { backgroundColor: colors.primary },
  secondaryButton: { backgroundColor: colors.panel, borderColor: colors.border, borderWidth: 1 },
  ...
  input: { minHeight: 46, borderWidth: 1, borderColor: colors.border, borderRadius: 12, backgroundColor: colors.panel, paddingHorizontal: 14, color: colors.text, fontSize: 15 },
  textArea: { minHeight: 116, paddingTop: 12, textAlignVertical: "top" },
  empty: { alignItems: "center", paddingVertical: 32 },
  emptyTitle: { color: colors.text, fontSize: 16, fontWeight: "700" },
  emptyBody: { color: colors.muted, textAlign: "center", marginTop: 6, fontSize: 13 },
