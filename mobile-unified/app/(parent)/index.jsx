        ...
        return (
          <Card key={c.id}>
            ...
            <View style={{ flexDirection: "row", gap: 8, marginTop: 12 }}>
              <Button title="Grades" variant="secondary" onPress={() => router.push("/(parent)/grades")} />
              <Button title="Attendance" variant="secondary" onPress={() => router.push("/(parent)/attendance")} />
            </View>
          </Card>
        );
      })}
