...
import { colors, radii, spacing, shadow } from "../../components/admin/theme";

const TILES = [
  { key: "students",       label: "Students",     icon: "👥", route: "/(admin)/students",        accent: colors.brand500 },
  { key: "doctors",        label: "Doctors",      icon: "🩺", route: "/(admin)/doctors",         accent: colors.info },
  { key: "admins",         label: "Admins",       icon: "🛡️", route: "/(admin)/admins",          accent: colors.warning },
  { key: "parents",        label: "Parents",      icon: "👨‍👩‍👧", route: "/(admin)/parents",         accent: "#f97316" },
  { key: "lectures",       label: "Lectures",     icon: "📚", route: "/(admin)/lectures",        accent: "#8b5cf6" },
  { key: "subjects",       label: "Subjects",     icon: "📖", route: "/(admin)/subjects",        accent: colors.brand600 },
  { key: "classes",        label: "Classes",      icon: "🏫", route: "/(admin)/classes",         accent: colors.info },
  { key: "weeks",          label: "Weeks",        icon: "🗓️", route: "/(admin)/weeks",           accent: "#06b6d4" },
  { key: "attendance",     label: "Attendance",   icon: "✅", route: "/(admin)/attendance",      accent: colors.success },
  { key: "grades",         label: "Grades",       icon: "📊", route: "/(admin)/grades",          accent: "#ec4899" },
  { key: "analytics",      label: "Analytics",    icon: "📈", route: "/(admin)/analytics",       accent: colors.brand500 },
  { key: "student-search", label: "Search",       icon: "🔍", route: "/(admin)/student-search",  accent: colors.warning },
  { key: "settings",       label: "Settings",     icon: "⚙️", route: "/(admin)/settings",        accent: "#64748b" },
];
