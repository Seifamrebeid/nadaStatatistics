      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white/80 backdrop-blur border-b border-slate-200 flex items-center px-4 lg:px-6 sticky top-0 z-20">
          ...
          {kids.length > 0 && (
            <div className="flex items-center gap-2 mr-3">
              ...
              <select
                ...
                className="text-sm border border-slate-200 rounded-lg px-2 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-brand"
              >
                {kids.map((c) => (
          ...
          <div className="hidden sm:flex items-center gap-3 text-sm">
            ...
            <span className="badge bg-brand-50 text-brand-700">Parent</span>
          </div>
        </header>
